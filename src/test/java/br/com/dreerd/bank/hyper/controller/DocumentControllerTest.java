...
public class DocumentControllerTest extends GeneratorInformation implements BaseControllerTest {
    private final static String ENDPOINT = "/documents";
    ...
    private List<DocumentDTO> dtoList = new ArrayList<>();

    final String MSG_ERROR_NOT_FOUND = "Document doesn't found";
    final String MSG_ERROR_INTERNAL_ERROR = "Not has possible save operation";


    @BeforeEach
    public void setUp() {
        dto = createDocument(DocumentDTO.class);
        dtoList.add(dto);
    }
