...
public class AddressControllerTest extends GeneratorInformation implements BaseControllerTest {
    private final static String ENDPOINT = "/addresses";
    private final List<AddressDTO> dtoList = new ArrayList<>();
    @Autowired
    ...
    final String MSG_ERROR_NOT_FOUND = "Address doesn't found";
    final String MSG_ERROR_INTERNAL_ERROR = "Not has possible save operation";


    @BeforeEach
    public void setUp() {
        dto = createAddress(AddressDTO.class);
        dtoList.add(dto);
    }
    ...
    public void mustReturnBusinessExceptionInternalErrorWhenSave() throws Exception {
        ...
        mockMvc.perform(postMethod)
                ...
                .andExpect(jsonPath("$.details").value(MSG_ERROR_INTERNAL_ERROR))
                .andExpect(status().isOk());
    }
